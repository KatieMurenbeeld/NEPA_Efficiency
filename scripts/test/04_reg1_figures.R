...
group.df <- map.conus.k4$Groups %>% as.data.frame(xy = TRUE)
...
ggsave(paste0("~/Analysis/NEPA_Efficiency/figures/fcm_nf_map_k4_", Sys.Date(), ".png"), plot = fcm_nf_map, width = 12, height = 12, dpi = 300)  
...
ggsave(paste0("~/Analysis/NEPA_Efficiency/figures/fcm_reg_map_k4_", Sys.Date(), ".png"), plot = fcm_reg_map, width = 12, height = 12, dpi = 300)  
